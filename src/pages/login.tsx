    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          '@type': 'BlogPosting',
          headline: 'User Login Profile',
          alternativeHeadline: 'Profile using Google Auth v2',
          image: ogimage,
          award: 'Best Login page ever built',
          editor: 'Donald Boulton',
          genre: 'search engine optimization',
          keywords: 'google profile user',
          wordCount: '1120',
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          name: 'Google User Login Profile',
          url: 'https://publiuslogic.com/login',
          image: {
            '@type': 'ImageObject',
            url: ogimage,
          ...
          publisher: {
            '@type': 'PubliusLogic',
            name: 'Google Login User Profile',
          },
