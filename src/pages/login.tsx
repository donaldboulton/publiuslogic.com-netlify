...
const Login = () => {
  ...
  return (
    <>
      <Stars />
      <div class="form-beams min-h-full flex flex-col">      
        <div className="">
          <div className="bg-[#121212] text-slate-300 flex flex-1 flex-col opacity-70 bg-scale-100">
              ...
              <div className="bg-scale-200 border-scale-500 flex flex-1 flex-shrink-0 flex-col items-center border-r border-slate-900 px-5 pb-8 pt-16 shadow-lg">
                <div className="flex w-[330px] flex-1 flex-col justify-center sm:w-[384px]">
                  ...
                  <div className="flex flex-col gap-5">
                    {!session ? <AuthForm /> : <Account key={session.user.id} session={session} />}
                  </div>
                </div>
              </div>
