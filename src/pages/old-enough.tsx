                            ...
                            <main className="bg-scale-200 border-scale-500 flex flex-1 flex-shrink-0 flex-col items-center border-r border-slate-700 px-5 pb-8 pt-16 shadow-lg">
                                        ...
                                        <div className="neon-div flex flex-col items-center">
                                            <span className="neonText neon-h1">
                                                <h1 className="text-2xl">
                                                    Angelina's Playlists
                                                </h1>
                                                <h2 className="text-scale-1100 ml-9 items-center justify-center text-lg">
                                                    Old Enough
                                                </h2>
                                            </span>
                                        </div>
                                ...
                                <div className="sm:text-center">
                                    <div className="text-scale-900 text-xs sm:mx-auto sm:max-w-sm">
                                        ...
                                        , and to receive periodic emails with
                                        updates.
                                    </div>
                                </div>
                            </main>
    ...
    return (
        <>
            ...
            >
                ...
                <meta
                    name="description"
                    content="PubliusLogic Old Enough Page."
                />
                <link
                    rel="sitemap"
