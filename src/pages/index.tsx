                    ...
                    <div className="font-inter">
                        <div className="relative flex content-center items-center justify-center">
                            ...
                            <div className="pointer-events-none absolute bottom-0 left-0 right-0 top-auto mt-4 h-[70px] w-full overflow-hidden transition-all duration-200">
                                ...
                                >
                                    <polygon
                                        className="fill-current text-slate-950 opacity-90"
                        ...
                        <section className="-mt-10 bg-slate-950 pb-10 text-slate-300 transition-all duration-200">
                            <div className="container mx-auto px-4">
                                        ...
                                        <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-wine-300 text-slate-200 shadow-lg shadow-wine-300/50 transition-all duration-200">
                                            <div className="flex-auto px-4 py-5">
                                                ...
                                                <h6 className="text-xl font-semibold">
                                                    <Link
                                                        to="/blog/commandments"
                                                        area-label="Commandments"
                                                ...
                                                <div className="mb-4 mt-2 text-slate-300">
                                                    The Laws of man have strayed
                                                    far from the truth of
                                                    Creation and Gods Laws.
                                                    Under Gods Law all Life is
                                                    precious and should be
                                                    preserved at all cost. Mans
                                                    laws care nothing for life;
                                                    you kill your, "Unborn
                                                    Children"!
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="w-full px-4 text-center md:w-4/12">
                                        <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-indigo-700 text-slate-200 shadow-lg shadow-indigo-700/50">
                                            <div className="flex-auto px-4 py-4">
                                                ...
                                                <div className="mb-4 mt-2 text-slate-300">
                                                    Creation Of All, was formed
                                                    through song that started
                                                    the dance of life from a
                                                    blank and formless verse,
                                                    bringing forth life to all.
                                                    For all to formalize there,
                                                    "Own Song"!
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative mb-8 flex w-full min-w-0 flex-col break-words rounded-lg bg-purple-600 text-slate-200 shadow-lg shadow-purple-600/50">
                                            <div className="flex-auto px-4 py-5">
                                                ...
                                                <div className="mb-4 mt-2 text-slate-200">
                                                    PubliusLogic is a Static
                                                    site using JAMstack
                                                    architecture. Built using
                                                    Gatsby, React, MDX, Tailwind
                                                    and Typescript on Netlify
                                                    Servers for, "Ultimate
                                                    Performance"!
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="-mt-12 mb-10 text-slate-200 md:-mt-4">
                                    ...
                                    <h2 className="m-auto flex max-w-xs justify-center text-2xl font-bold">
                                        Donald W. Boulton
                                    </h2>
                                    <a
                                    ...
                                    <div className="m-auto my-2 mb-6 max-w-xl justify-center text-slate-200 hover:text-slate-300">
                                        <div className="justify-items-center text-center">
                                            Left Hand of Father God since the
                                            beginning of time!{' '}
                                        </div>
                                        <div className="justify-items-center text-center">
                                            Self Taught Full Stack Developer.
                                            Gatsby, MDX, TypeScript Tailwind
                                            CSS.
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8 flex flex-wrap items-center">
                                        <div className="mb-6 ml-auto mr-auto w-full px-4 md:w-5/12">
                                            ...
                                            <div className="first-letter:float-left first-letter:mr-3 first-letter:text-7xl first-letter:font-bold first-letter:text-slate-300 first-line:uppercase first-line:tracking-widest">
                                                I have been Retired from birth
                                                until I become 65, then I am
                                                getting to work, start singing,
                                                finding somewhere the people
                                                like to talk about God, Life,
                                                Love, Truth! Starting my
                                                Trinity's church on Earth. I Had
                                                to Walk this Earth twice as long
                                                as my Son Jesus. "To Know All
                                                before Action"!
                                            </div>
                                            ...
                                            <div className="mb-4 mt-0 text-lg font-light leading-relaxed text-slate-200">
                                                <div>
                                                    ...
                                                    <div>
                                                        Human Instruction Manuel
                                                        the Last Testament to
                                                        the Holy Bible.
                                                    </div>
                                                </div>
                                                <a
        ...
        <>
            ...
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    alternativeHeadline:
                        'At PubliusLogic we publish logic and Gods truth',
                    image: ogimage,
