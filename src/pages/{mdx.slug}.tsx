        ...
        <PageTransition ref={ref}>
          <div className="left-beams -mt-10 object-cover">
            ...
            <div className="mb-20 mt-10 font-inter">
              <section className="prose-text:text-slate-900 prose-text:dark:text-slate-200 prose mx-auto mb-10 mt-2 max-w-screen-lg px-4 md:prose-lg lg:prose-xl prose-a:text-slate-300 hover:prose-a:text-slate-400 lg:px-0">
