...
function BlogPost({ data }: PageProps<DataProps>, ref: BlogPostRef) {
    const {
        ...
        timeToRead,
        id,
        customWrapper = ImageColWrapperPage,
        imgClass = '',
    } = data.mdx
    ...
    return (
        <>
            ...
            >
                ...
                <meta
                    name="description"
                    content={props.data.mdx.frontmatter.description}
                />
                ...
                <meta
                    name="twitter:title"
                    content={props.data.mdx.frontmatter.title}
                />
                ...
                <meta
                    ...
                    content={props.data.mdx.parent.modifiedTime}
                />
