              ...
              <div className="px-4 py-5 text-slate-900 dark:text-slate-200 sm:p-6">
                <div className="-mx-3 mb-6 flex flex-wrap">
                  <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="mb-3 block w-full appearance-none rounded border-slate-300 bg-slate-300 p-2.5 px-4 py-3 pl-14 leading-tight text-slate-900 focus:border-wine-300 focus:outline-none focus:ring-slate-500 dark:border-slate-900 dark:bg-slate-950 dark:text-slate-200 sm:text-sm opacity-70"
                        id="firstName"
                        name="firstName"
                        type="text"
                  ...
                  <div className="w-full px-3 md:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="block w-full appearance-none rounded border-slate-300 bg-slate-300 p-2.5 px-4 py-3 pl-14 leading-tight text-slate-900 focus:border-wine-300 focus:outline-none focus:ring-slate-500 dark:border-slate-900 dark:bg-slate-950 dark:text-slate-200 sm:text-sm opacity-70"
                        id="lastName"
                        name="lastName"
                        type="text"
                ...
                <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-400 bg-gray-200 pl-3 pr-3 text-gray-900 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300">
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="h-5 w-5 text-gray-500 dark:text-gray-300 opacity-70"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <input
                        ...
                        className="mt-1 block w-full rounded-md border-slate-800 bg-slate-300 p-2.5 px-4 py-3 pl-14 leading-tight text-slate-900 shadow-sm focus:border-wine-300 focus:ring-slate-500 dark:bg-slate-950 dark:text-slate-700 sm:text-sm opacity-70"
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="relative">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center rounded-l-md border border-r-0 border-gray-400 bg-gray-200 pl-3 pr-3 text-gray-900 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-300 opacity-70">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                      ...
                      <textarea
                        id="message"
                        name="message"
                        className="mt-1 block w-full rounded-md border-slate-300 bg-slate-300 p-2.5 pl-14 text-slate-900 caret-blue-500 shadow-sm focus:border-wine-300 focus:caret-indigo-500 focus:ring-slate-500 dark:border-slate-900 dark:bg-slate-950 dark:text-slate-200 sm:text-sm opacity-70"
                        rows={5}
                        name="text"
