...
const ContactForm: FC<ContactFormProps> = props => {
  ...
  return (
    <div className="mt-5 mb-24 rounded-lg bg-slate-300 text-slate-900 dark:bg-slate-900 dark:text-slate-200 lg:col-span-2 lg:mt-0">
                ...
                <div className="-mx-3 mb-6 flex flex-wrap">
                  <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="mb-3 block w-full appearance-none rounded border-slate-800 bg-slate-300 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-900 focus:border-fuchsia-500 focus:outline-none focus:ring-slate-500 dark:bg-slate-900 dark:text-slate-200"
                        id="firstName"
                        name="firstName"
                        type="text"
                  ...
                  <div className="w-full px-3 md:w-1/2">
                    <label
                      className="mb-2 block bg-slate-300 text-xs font-bold uppercase tracking-wide text-slate-900 dark:bg-slate-900 dark:text-slate-700"
                      htmlFor="lastName"
                    >
                      Last Name
                    </label>
                    <div className="relative">
                      ...
                      <input
                        className="block w-full appearance-none rounded border-slate-800 bg-slate-300 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-900 focus:border-fuchsia-500 focus:outline-none focus:ring-slate-500 dark:bg-slate-900 dark:text-slate-200"
                        id="lastName"
                        name="lastName"
                        type="text"
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        autoComplete="on"
                        placeholder="Email"
                        className="mt-1 block w-full rounded-md border-slate-800 bg-slate-300 p-2.5 py-3 px-4 pl-14 leading-tight text-slate-900 shadow-sm focus:border-fuchsia-500 focus:ring-slate-500 dark:bg-slate-900 dark:text-slate-200 sm:text-sm"
                        {...register('email', {
                  ...
                  <div className="col-span-6">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        id="message"
                        name="message"
                        className="mt-1 block w-full rounded-md border-slate-800 bg-slate-300 p-2.5 pl-14 text-slate-900 caret-blue-500 shadow-sm focus:border-fuchsia-500 focus:caret-indigo-500 focus:ring-slate-500 dark:bg-slate-900 dark:text-slate-200 sm:text-sm"
                        rows={5}
                        name="text"
              ...
              <div className="float-right mt-4 mr-8">
                <span className="md:ml-10">
                  ...
                  >
                    ...
                    <span className="ml-1 mt-2 text-slate-900 dark:text-slate-700">Netlify</span>
                  </a>
                </span>
                <span className="ml-2">
                  <a
