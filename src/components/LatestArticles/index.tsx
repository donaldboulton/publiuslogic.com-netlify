                ...
                <div className="m-4 mx-auto max-w-7xl bg-slate-900 px-4 py-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl py-4 sm:py-8 lg:max-w-none lg:py-10">
                        <div className="flex flex-row items-center">
                            <h2 className="text-2xl font-extrabold text-slate-300 md:text-2xl">
                                Latest Articles
                            </h2>
                            <Link
                                id="blog"
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    Last Testament to the Holy
                                                    Bible. Intro Enclosed is the
                                                    creation of all, how To Pray
                                                    to The Holy Trinity
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    ...
                                                    Here I am going to reflect
                                                    on what The Christian Bible,
                                                    Sufism as Tasawwuf
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    Prelude As in all my
                                                    writings are written for my
                                                    Children born since 2000.
                                                    Only there purity can
                                                    cleanse the
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    Warning Attack! Shelter Your
                                                    Minds! Kind of like last
                                                    years playtime post, it's
                                                    not very
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    USA Election Our 2020
                                                    election was the most major
                                                    Racketeering scheme ever,
                                                    using foreigners
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    To Sophistry My writing of
                                                    God in the past got
                                                    interpreted as philosophy. I
                                                    will make it real clear what
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    Applause Button Click the
                                                    flowers 🎉 for claps in the
                                                    Bio Section above and see an
                                                    hear the Magic. 🤟
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    GDPR cookie consent with
                                                    Gatsby using modules
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div>
                                                    React Netlify Forms, is easy
                                                    with Bot fields and
                                                    invisible reCaptcha
                                                    including dropZone for image
                                                    upload
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <Link to={`/${post.slug}`}>
                                            <div className="mb-10 w-full rounded-lg bg-slate-950 p-2 text-slate-300 md:grid md:grid-cols-2">
                                                <div className="rounded px-4 text-slate-300 md:col-span-2">
                                                    ...
                                                    <span className="block p-2 pl-0 pt-1 text-sm">
                                                        {
                                                            post.frontmatter
                                                                .description
                                                        }
