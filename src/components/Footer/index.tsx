                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap">
                        <div className="w-full px-4 lg:w-6/12">
                            <h4 className="text-3xl font-semibold text-slate-300">
                                Let's keep in touch!
                            </h4>
                            ...
                            <div className="mt-4">
                                ...
                                <h5 className="mb-2 mt-0 text-lg text-slate-300">
                                    Get exclusive newsletter-only content now
                                    and then
                                </h5>
                                <Subscriptions />
                            </div>
                        ...
                        <div className="w-full px-4 lg:w-6/12">
                            <div className="items-top -mb-2 flex flex-wrap">
                                <div className="ml-auto w-full px-4 lg:w-4/12">
                                    <span className="mb-2 block text-lg font-semibold uppercase text-slate-300">
                                        Useful Links
                                    </span>
                                ...
                                <div className="w-full px-4 lg:w-4/12">
                                    <span className="mb-2 block text-lg font-semibold uppercase text-gray-100">
                                        Resources
                                    </span>
                                    <ul className="list-unstyled">
                                        <li>
