                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="lg:text-center">
                                ...
                                <div className="mt-2 max-w-2xl text-xl lg:mx-auto">
                                    PubliusLogic has Topics on God / Creation,
                                    Law, USA and World Governments, Life
                                    Matters.
                                </div>
                                <div className="mt-2 max-w-2xl text-xl lg:mx-auto">
                                    Focusing on the Re-Creation of Mankind to
                                    the Spiritual Beings you have forgotten
                                    about, as you only live in the Flesh.
                                </div>
                                <div className="mt-2 max-w-2xl text-xl lg:mx-auto">
                                    ...
                                    {features.map((feature) => (
                                        ...
                                        >
                                            <dt>
                                                ...
                                                <div className="ml-16 text-lg font-medium leading-6">
                                                    {feature.name}
                                                </div>
                                            </dt>
                                            <dd className="ml-16 mt-2 text-base">
                                                {feature.description}
                                            </dd>
                                        </div>
                                    ))}
