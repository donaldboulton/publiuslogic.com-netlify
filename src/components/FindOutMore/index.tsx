          ...
          <div className="mt-4 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
            {callouts.map(callout => (
              <div key={callout.name} className="group relative">
                <div className="relative h-80 w-full overflow-hidden rounded-lg sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1 lg:aspect-h-1 group-hover:opacity-75 sm:h-64">
                  <img
