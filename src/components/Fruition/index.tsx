                        ...
                        <div className="relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-wine-300 text-slate-300 shadow-lg">
                            ...
                            <div className="relative mb-4 p-8">
                                <svg
                                    ...
                                    viewBox="0 0 583 95"
                                    className="absolute -top-[94px] left-0 block h-[95px] w-full"
                                >
                                    <polygon
                                ...
                                <div className="mt-2 text-lg font-light text-slate-300">
                                    Fruition has come and gone. Revelation
                                    22:12,
                                    <div>
                                        Whatever Horse you ride or path your on
                                        in life. You will be stuck on that path
                                        for eternity.
                                    </div>
                                </div>
                            </div>
