            ...
            <>
                <LazyMotion features={loadFeatures}>
                    <Section>
                        <Wrapper
                            ref={ref}
                            className="overscroll-contain opacity-75"
                        >
                            <Disclosure>
                                {({ open }) => (
                                    <>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <m.path
                                                            ...
                                                            animate={
                                                                open
                                                                    ? 'enterDiscloserScreen'
                                                                    : 'exitDiscloserScreen'
                                                            }
                                                            variants={
                                                                enterDiscloserScreenIconVariants
                                                            }
                                                            transition={{
                                                                duration,
                                                            }}
                                                        ...
                                                        <m.path
                                                            ...
                                                            variants={
                                                                exitDiscloserScreenIconVariants
                                                            }
                                                            style={{
                                                                pathLength,
                                                                opacity,
                                        ...
                                        >
                                            {({
                                                ...
                                                <Disclosure.Panel
                                                    className="gatsby-highlight nav-scroll"
