...
const Table = () => {
    ...
    return (
        <LazyMotion features={loadFeatures}>
            <m.section
                className="center items-stretch font-sans"
                            ...
                            <table className="text-md w-full rounded-t-lg text-left text-slate-900 dark:text-slate-200 sm:rounded-md">
                                <thead className="text-md rounded-t-lg bg-slate-200 uppercase text-slate-900 dark:bg-slate-800 dark:text-slate-200">
                                    <tr>
                                        <th
                                            scope="col"
                                            className="ml-2 px-6 py-3 text-slate-900 dark:text-slate-200"
                                        >
                                            Article Name
                                        </th>
                                        <th
                                            scope="col"
                                            className="px-6 py-3 text-slate-900 dark:text-slate-200"
                                        >
                                            Dated
                                        </th>
                                        <th
