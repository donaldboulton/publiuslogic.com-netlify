                                        ...
                                        <>
                                            ...
                                            <Disclosure.Panel className="text-md px-4 pb-2 pt-4 text-slate-200">
                                                <div className="text-md">
                                                    Only change in song is verse
                                                    1, to, "Heart of a Child",
                                                    from, "We're are caught in a
                                                    trap
                                                </div>
                                                <Center>
                                                    I Already Know Angie!
                                                </Center>
                                                <div>
                                                    Way more Beautiful than
                                                    Elvis's version of which I
                                                    saw live along time ago.
                                                    1972 or 73?{' '}
                                                </div>
