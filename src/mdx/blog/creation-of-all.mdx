...
<GatsbyImage alt="A Trinity Subset in All Colors" imgClass="object-cover object-center w-full h-full" image={getImage(props.localImages[0])} />
...
<GatsbyImage alt="A Trinity in All Substance" imgClass="object-cover object-center w-full h-full rounded-lg" image={getImage(props.localImages[1])} />
