...
What we know: Lo adding third-party scripts on the main thread impacts performance by delaying the time it takes for your site to become available and ready to use by your end users.
...
<UserProfile buttonLink="https://partytown.builder.io/" title="Builder.io" titleLink="https://www.youtube.com/watch?vXSKLk87Ys4" link="https://partytown.builder.io/" description="Party Town">
