...
Using only the needed sub-features of Framer Motion

```tsx:title=Typescript Animated Sections
import * as React from 'react'
import { useRef, ReactNode } from 'react'
import { useInView, LazyMotion, m } from 'framer-motion'

/* See FramersFeatures Component Below*/
...
```tsx:title=sub Features when needed
