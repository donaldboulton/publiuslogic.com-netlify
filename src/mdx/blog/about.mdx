...
<GatsbyImage alt="Content Security Policy" imgClass="object-cover object-center w-full h-full rounded-lg" image={getImage(props.localImages[1])} />
...
<GatsbyImage alt="Headers test Content-Security-Policy" imgClass="object-cover object-center w-full h-full rounded-lg" image={getImage(props.localImages[2])} />
...
<GatsbyImage alt="Site Structure" imgClass="block object-cover object-center w-full h-full rounded-lg" image={getImage(props.localImages[3])} />
...
<GatsbyImage alt="Buy Me A Coffee" imgClass="object-cover w-full h-full object-center rounded-lg" image={getImage(props.localImages[4])} />
