...
🚀 This 🔗 [Repo v5](https://github.com/donaldboulton/publiuslogic.com-netlify/) stores the Gatsby site hosted at publiuslogic.com. I use it to write about my personal interests, ranging from theoretical physics and spiritual learning; to A Human Basic Instructions Manuel, web development and spending time outdoors... oh and not to forget breaking conventions like a React Site with Json-Ld per template for SEO, Internet Positioning, and a A+ security rating. 💯
