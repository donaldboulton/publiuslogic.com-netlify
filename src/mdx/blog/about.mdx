...
I employ <HoverMenuWithTransition title="Feynman">Feynman / Wisdom</HoverMenuWithTransition> in explications of Code, Government, Law and God with a little Wisdom according to <HoverMenuWithTransition title="Sufi">Sufi / Sufism Wisdom</HoverMenuWithTransition> for kindness and brevity.
...
If you read them in order they have a timely purpose, <HoverMenuWithTransition title="Something you do not need!">playtime</HoverMenuWithTransition> is calling out the evil one's.
...
Github and Google OAuth v2 with `Supabase`
