...
Both collaborated durning WWII to eliminate the Jews from europe. Then the european counries wanted the gone so Israel was implemented. The say they are Jewish so they can get.
