...
This Site uses Gatsby Version Five, with React `18.2.0` Node `18.12.1` with NPM `8.11.0`
...
What kind of non-sense is unfortunate. It still works just fine with `"gatsby-plugin-mdx": "3.20.0"` as long as you update your queries to where Gatsby version `5.1.0`, it still works.
...
There are many more new improvements beyond these, but we’ll have to wait for the official release. In the meantime, you can check out the v5 alpha and try it out yourself, and we’d love to hear your thoughts about the alpha in the GitHub discussion!

Version Gatsby Version 5.1.0 is now out and out of Alpha stage. Convert and update you Gatsby sit now for shocking performance and Love.
