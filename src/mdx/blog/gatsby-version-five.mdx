...
What kind of non-sense is unfortunate. It still works just fine with `"gatsby-plugin-mdx": "3.20.0"` as long as you update your queries to where Gatsby version `5.0.1` works.
...
Version Gatsby Version 5.0.1 is now out and out of Alpha stage. Convert and update you Gatsby sit now for shocking performance and Love.
