...
What kind of non-sense is unfortunate. It still works just fine with `"gatsby-plugin-mdx": "3.20.0"` as long as you update your queries to where Gatsby version `5.2.0`, it still works.
...
Version Gatsby Version 5.1.0 is now out and out of Alpha stage. Convert and update you Gatsby site now for shocking performance and Love.
