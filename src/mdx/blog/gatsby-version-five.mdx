...
## Gatsby Version Five v5.3.1

This Site uses Gatsby Version `"gatsby": "^5.3.1"`, with React `18.2.0` Node `18.12.1` with NPM `8.11.0`.


Now I can use Gatsby 5.3.1, with MDX version 3.20.0
