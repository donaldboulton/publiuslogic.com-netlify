...
## Gatsby Version Five v5.3.3

This Site uses Gatsby Version `"gatsby": "^5.3.3"`, with React `18.2.0` Node `18.12.1` with NPM `8.11.0`.

Now I can use Gatsby 5.3.3, with MDX version 3.20.0
...
What kind of non-sense is unfortunate. It still works just fine with `"gatsby-plugin-mdx": "3.20.0"` as long as you update your queries to where Gatsby version `5.3.1`, still works.
...
<UserProfile buttonLink="https://www.youtube.com/" title="Partial Hydration" titleLink="https://www.youtube.com/watch?v=C-WrnfUm33k" link="https://www.youtube.com/watch?v=C-WrnfUm33k" description="Gatsby Version Five">
...
<YouTube youTubeId="v=C-WrnfUm33k" />
...
<UserProfile buttonLink="https://www.gatsbyjs.com/gatsby-5/" title="Showcase Video" titleLink="https://www.youtube.com/watch?v=lgc6SrINnSc" link="https://www.youtube.com/watch?v=lgc6SrINnSc" description="Gatsby Version Five">
...
<YouTube youTubeId="v=lgc6SrINnSc" />
...
Version Gatsby Version 5.3.1 is now out and out of Alpha stage. Convert and update you Gatsby site now for shocking performance and Love.
