...
After I posted this it was Gatsby version 5.0.1 and Gatsby core not MDX had its API as "unstable_shouldOnCreateNode" ->  Gatsby got ahold of this page and denied anyone to use MDX 3.20.0 by renaming that API from gatsby core to "shouldOnCreateNode". 

How evil and what a lie they said the api for create node was in MDX but it was in gatsby Core. Fuck head's I am going to NEXT, shit like that sucks and your liers and incompetent.
