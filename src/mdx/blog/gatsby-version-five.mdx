...
This Site uses Gatsby Version `"gatsby": "^5.12.4"`, with React `18.2.0` Node `20.7.0` with NPM `8.11.0`.

Now I can use Gatsby 5.12.4, with MDX version 3.20.0 rebuilt and updated as a plugin.
