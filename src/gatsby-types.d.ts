...
declare namespace Queries {
  ...
  type ImagesForGalleryQuery = {
    readonly images: {
      readonly edges: ReadonlyArray<{
        readonly node: {
          readonly name: string
          readonly childImageSharp: {
            readonly thumb: import('gatsby-plugin-image').IGatsbyImageData
            readonly full: import('gatsby-plugin-image').IGatsbyImageData
          } | null
        }
      }>
    }
  ...
  type Unnamed_1_Query = {
    readonly categories: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null }> }
    readonly tags: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null }> }
  }
}
